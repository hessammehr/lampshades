...
## Marimo notebook
The included marimo notebook is ideal for designing your own shapes, simply run

```
uvx marimo edit --sandbox make_lampshade.py
```

The code was initially generated by ChatGPT.